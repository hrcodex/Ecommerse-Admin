            ...
            @endif
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        <h4 class="card-title flex-grow-1">Edit Brand</h4>

                        <a href="{{ route('admin.brand.list') }}" class="btn btn-sm btn-blue">
              ...
              <div class="card-body">
                <div class="row">
                     <div class="col-lg-6">
                               ...
                               <div class="mb-3">
                                    <input type="file" id="category-image" name="image" value="{{ old('image') }}" class="form-control" onchange="previewImage(event)">
                     ...
                     <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <img id="preview" class="rounded" src="{{ asset($brand->logo) }}" alt="Preview Image">
                        ...
                        <div class="row">
                             <div class="col-lg-6">
                                       ...
                                       <div class="mb-3">
                                            ...
                                            <input type="text" id="category-title" name="name" value="{{ $brand->name }}" class="form-control" >
                                       </div>
                             ...
                             <div class="col-lg-6">
                                ...
                                <select class="form-control" name="status" id="crater" data-choices data-choices-groups data-placeholder="Select Crater">
                                     ...
                                     <option value="Unpublished" @if ($brand->status =='Unpublished') selected @endif>Unpublished</option>
                                </select>
                             ...
                             <div class="col-lg-12">
                                  <div class="mb-0" id="ckeditor">
                                       ...
                                       <textarea class="form-control bg-light-subtle summernote" id="summernote" name="description" rows="7" placeholder="Type description">{!! $brand->description !!}</textarea>
                                  </div>
                             </div>
                             <div class="col-lg-12">
                                <div class="mt-3">
                                    <label for="category-title" class="form-label">Brand Official  Website Link</label>
                                    <input type="text" id="category-title" name="website" value="{{ $brand->website }}" class="form-control" placeholder="https://......">
                               </div>
                             </div>
                        </div>
                   </div>
