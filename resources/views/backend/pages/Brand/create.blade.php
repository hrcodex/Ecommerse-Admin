            ...
            @endif
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        <h4 class="card-title flex-grow-1">Create Brand</h4>
              ...
              <div class="card-body">
                <div class="row">
                     <div class="col-lg-6">
                               ...
                               <div class="mb-3">
                                    <input type="file" id="category-image" name="image" value="{{ old('image') }}" class="form-control" >
                        ...
                        <div class="row">
                             <div class="col-lg-6">
                                       ...
                                       <div class="mb-3">
                                            ...
                                            <input type="text" id="category-title" name="name" value="{{ old('name') }}" class="form-control" >
                                       </div>
                             ...
                             <div class="col-lg-12">
                                <div class="mt-3">
                                    ...
                                    <input type="text" id="category-title" name="website" value="{{ old('website') }}" class="form-control" placeholder="https://......">
                               </div>
                             </div>
                        </div>
                   </div>
