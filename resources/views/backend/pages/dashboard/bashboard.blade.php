                             ...
                             <div class="card-body">
                                  <div class="row">
                                       ...
                                       <div class="col-6 text-end">
                                            <p class="text-muted mb-0 text-truncate">Paiding Orders</p>
                                            <h3 class="text-dark mt-1 mb-0">23</h3>
                                       </div> <!-- end col -->
                                  </div> <!-- end row-->
                             </div> <!-- end card body -->
                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                  <div class="d-flex align-items-center justify-content-between">
                                       <div>
                                            ...
                                            <span class="text-danger ms-1 fs-12">Aprove Painding Orders !</span>
                                       </div>
                                       <a href="#!" class="text-reset fw-semibold fs-12">View All</a>
                                  </div>
                             </div> <!-- end card body -->
                        </div> <!-- end card -->
                   </div> <!-- end col -->
                        ...
                        <div class="card overflow-hidden">
                             <div class="card-body">
                                  <div class="row">
                                       ...
                                       <div class="col-6 text-end">
                                            <p class="text-muted mb-0 text-truncate">Processing Order</p>
                             ...
                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                  <div class="d-flex align-items-center justify-content-between">
                                       <div>
                                            <span class="text-success"> <i class="bx bxs-up-arrow fs-12"></i> Prepare for Delivery</span>
                                            <span class="text-muted ms-1 fs-12"></span>
                                       </div>
                                       <a href="#!" class="text-reset fw-semibold fs-12">View All</a>
                                  </div>
                             </div> <!-- end card body -->
                        ...
                        <div class="card overflow-hidden">
                             <div class="card-body">
                                  <div class="row">
                                       ...
                                       <div class="col-6 text-end">
                                            <p class="text-muted mb-0 text-truncate">Waiting For Shipping</p>
                                            <h3 class="text-dark mt-1 mb-0">55</h3>
                                       </div> <!-- end col -->
                                  </div> <!-- end row-->
                             </div> <!-- end card body -->
                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                  <div class="d-flex align-items-center justify-content-between">
                                       <div>
                                            <span class="text-success"> <i class="bx bxs-up-arrow fs-12"></i> Aprove Shipment</span>
                                            <span class="text-muted ms-1 fs-12"></span>
                                       </div>
                                       <a href="#!" class="text-reset fw-semibold fs-12">View All</a>
                                  </div>
                    ...
                    <div class="card overflow-hidden">
                         <div class="card-body">
                              <div class="row">
                                   ...
                                   <div class="col-6 text-end">
                                        <p class="text-muted mb-0 text-truncate">Total Sale</p>
                                        <h3 class="text-dark mt-1 mb-0">90000 TK</h3>
                                   </div> <!-- end col -->
                              </div> <!-- end row-->
                         </div> <!-- end card body -->
                         <div class="card-footer py-2 bg-light bg-opacity-50">
                              <div class="d-flex align-items-center justify-content-between">
                                   <div>
                                        <span class="text-success"> <i class="bx bxs-up-arrow fs-12"></i> 30400 TK </span>
                             ...
                             <div class="card-body">
                                  <div class="row">
                                       ...
                                       <div class="col-6 text-end">
                                            ...
                                            <h3 class="text-dark mt-1 mb-0">65</h3>
                                       </div> <!-- end col -->
                                  </div> <!-- end row-->
                             </div> <!-- end card body -->
                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                  <div class="d-flex align-items-center justify-content-between">
                                       <div>
                                            <span class="text-success"> <i class="bx bxs-up-arrow fs-12"></i> 22</span>
                                            <span class="text-muted ms-1 fs-12">This Month newly Added</span>
                                       </div>
                                       <a href="#!" class="text-reset fw-semibold fs-12">View More</a>
                                  </div>
                             </div> <!-- end card body -->
                        ...
                        <table class="table mb-0">
                             ...
                             <tbody>
                                  <tr>
                                       ...
                                       <td>29 April 2024</td>
                                       <td>
                                            <img src="{{ asset('backend/assets') }}/images/products/product-1(1).png" alt="product-1(1)" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
                                  ...
                                  <tr>
                                       ...
                                       <td>25 April 2024</td>
                                       <td>
                                            <img src="{{ asset('backend/assets') }}/images/products/product-4.png" alt="product-4" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
                                  ...
                                  <tr>
                                       ...
                                       <td>25 April 2024</td>
                                       <td>
                                            <img src="{{ asset('backend/assets') }}/images/products/product-5.png" alt="product-5" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
                                  ...
                                  <tr>
                                       ...
                                       <td>21 April 2024</td>
                                       <td>
                                            <img src="{{ asset('backend/assets') }}/images/products/product-6.png" alt="product-6" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
                                  ...
                                  <tr>
                                       ...
                                       <td>18 April 2024</td>
                                       <td>
                                            <img src="{{ asset('backend/assets') }}/images/products/product-1(2).png" alt="product-1(2)" class="img-fluid avatar-sm">
                                       </td>
                                       <td>
