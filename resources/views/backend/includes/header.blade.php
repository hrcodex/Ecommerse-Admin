    ...
    <div class="container-fluid">
         <div class="navbar-header">
              <div class="d-flex align-items-center">
                   ...
                   <!-- Menu Toggle Button -->
                   <div class="topbar-item">
                    <img src="{{ asset('backend') }}/assets/images/hrcodex/hrcodex_logo.png" width="80" class="logo-sm pe-none  mb-0" alt="logo dark">
                   ...
                   <div class="dropdown topbar-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                             ...
                             <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button class="dropdown-item text-danger"><i class="bx bx-log-out fs-18 align-middle me-1"></i><span class="align-middle">Logout</span></button>
                            </form>
