        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="about-l">
                        <ul class="about-link">
                            <li class="go-home"><a href="index1.html">Home | Collection</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="categories-page-filter">
                        ...
                        <ul class="all-option collapse" id="category-filter">
                            ...
                            <li class="grid-list-option">
                                ...
                                <a href="javascript:void(0)">{{ $category->name }} <span class="grid-items">({{ $Cat_count->count() }})</span></a>
                            </li>
                        ...
                        <ul class="grid-product">
                            ...
                            <li class="grid-items" style="margin-block: 10px">
                                ...
                                <div class="caption" style="border-bottom: 1px solid #2277aa;border-left: 1px solid #2277aa;border-right: 1px solid #2277aa;margin: 0px;padding: 0px">
                                    <h3><a href="product-style-6.html" style="padding-right: 3px;padding-left: 2px">{{ $product->name }}</a></h3>
                                   <div class="pro-price">

                                    <span class="new-price">{{ $product->sale_price }} TK</span>
                                    <div class="pro-price" >
                                        <a href="{{ route('product-details') }}" class="new-price hrx-order-button-shop "><span style="padding: 5px">Order Now</span></a>
                                    </div>
                                </div>
